          ...
          <div>
            ...
            <div class="group relative">
              ...
              <input
                ...
                type="date"
                :class="[inputClass, { 'border-error-500 focus:border-error-500 focus:ring-error-500/10': form.errors.tanggal_mulai }]"
              />
            </div>
          ...
          <div>
            ...
            <div class="group relative">
              ...
              <input
                ...
                type="date"
                :class="[inputClass, { 'border-error-500 focus:border-error-500 focus:ring-error-500/10': form.errors.tanggal_selesai }]"
              />
            </div>
...
import { UserCircleIcon, GridIcon, BarChartIcon, UserGroupIcon, CalenderIcon, FlagIcon, DocsIcon, SendIcon, BoxCubeIcon } from '@/icons'
